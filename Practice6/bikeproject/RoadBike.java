...
public class RoadBike extends Bike implements RoadParts{
    ...
    public RoadBike(String handleBars, String frame,
                    String tyres, String seatType, int numGears,
    ...
    public void setTyreWidth(int newValue) { tyreWidth = newValue; }
    public void setPostHeight(int newValue) { postHeight = newValue; }
    ...
    public void printDescription()
    {
        ...
        System.out.println("This Roadbike bike has " +
